...
import_file = local_path + "\\Attachment\\Organization-SeleniumPython.xls"
...
def Organization_ImportUser():
    ...
    wrkbk.save(local_path + data["attached_file"]["organization_import"])
    
    Commands.Wait10s_InputElement("//*[@id='file']", local_path + data["attached_file"]["organization_import"])
...
NewOrganization_Execution("https://tg01.hanbiro.net/ngw/app/#", "OKM<7W+hbYPKN@d")
# NewOrganization_Execution("http://qavn.hanbiro.net/ngw/app/#", "$Bhngk6@")
